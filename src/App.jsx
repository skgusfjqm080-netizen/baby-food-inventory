...
const saveBtn     = { width:"100%", padding:"14px", borderRadius:14, border:"none", background:"linear-gradient(135deg,#FF8C69,#FFB347)", color:"#fff", fontSize:16, fontWeight:800, cursor:"pointer" };import { useState, useEffect } from "react";
